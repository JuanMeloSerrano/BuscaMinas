<template>
  <div class="tablero">
    ...
    <div class="datos">
      ...
      <div class="nombre">
        <label>Nombre: </label>
        <input @keyup.enter="guardarNombre(input)"  class="inputNombre" type="text" id="idInput" maxlength="10">

        <div class="nombreRecord">
        </div>

      </div>

      <div class="record">
        <div class="nombreRecord"></div>
      </div>
...
export default {
  ...
  methods: {
  //  guardarNombre(){
  //      localStorage.setItem('nombreJugador', Text)
  //  },
